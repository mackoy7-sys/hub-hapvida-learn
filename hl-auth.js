...
(function () {
  ...
  async function doLogin(){
    ...
    if(r.error){ msg("E-mail ou senha inválidos. Se é o seu primeiro acesso, use \"Criar conta\". Se o problema continuar, solicite apoio ao administrativo.","err"); return; }
  ...
  async function doForgot(){
    ...
    msg("Se houver conta com este e-mail, o código chega em alguns minutos (confira o lixo eletrônico). Não chegou? Provavelmente a sua conta foi criada com OUTRO endereço — use \"Criar conta\", ou solicite apoio ao administrativo.","ok");
  }
